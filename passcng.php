    ...
    <body style="margin-bottom: 100;">
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                if(password_verify($cpass,$row['Password'])){
                    if($npass==$rtpass){
                        ...
                        $sql="update users set Password='$pwd' where User_Name='$uname'";
                        if(mysqli_query($conn,$sql)){
                            header("location: userprof.php?pcsucc=1");
                            exit();
                        }
                        else{
                            die("SQL Query error");
        ...
        <div class="container mt-5">
                <div class="row">
                    ...
                    <form action="passcng.php" method="post">
                        <div class="mb-4 p-2 col-md-8 elements-center">
                            <label for="cpass" class="form-label">Current password</label>
                            <input type="password" class="form-control" id="cpass" name="cpass" " placeholder="Your Current Password">
                        </div>
                        <div class="mb-4 p-2 col-md-8 elements-center">
                        ...
                        <div class="mb-4 p-2 col-md-8 elements-center d-flex justify-content-center">
                            <a class="w-50 mx-2 btn btn-secondary" href="userprof.php">Back</a>
